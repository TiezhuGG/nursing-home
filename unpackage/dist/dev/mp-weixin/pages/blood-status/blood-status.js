...
var _bloodStatus = _interopRequireDefault(__webpack_require__(/*! ./pages/blood-status/blood-status.vue */ 38));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/* harmony import */ var _blood_status_vue_vue_type_template_id_54a461d8___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./blood-status.vue?vue&type=template&id=54a461d8& */ 39);
/* harmony import */ var _blood_status_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./blood-status.vue?vue&type=script&lang=js& */ 43);
...
/* harmony import */ var _blood_status_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./blood-status.vue?vue&type=style&index=0&lang=scss& */ 45);
...
var render = function() {
  ...
  var m0 = __webpack_require__(/*! ../../static/images/heart.png */ 32)

  var m1 = __webpack_require__(/*! ../../static/images/more.png */ 20)

  var m2 = __webpack_require__(/*! ../../static/images/back-green.png */ 41)

  var m3 = __webpack_require__(/*! ../../static/images/go-green.png */ 42)

  var m4 = __webpack_require__(/*! ../../static/images/back-green.png */ 41)

  var m5 = __webpack_require__(/*! ../../static/images/go-green.png */ 42)

  var m6 = __webpack_require__(/*! ../../static/images/back-green.png */ 41)

  var m7 = __webpack_require__(/*! ../../static/images/go-green.png */ 42)
...
//
//
var _self;var canvaLineA = null;var _default = { data: function data() {return { navTitles: ['血压', '血氧', '血糖'], currentIndex: 0, cWidth: '', cHeight: '', pixelRatio: 1, this_week: '6月7日-6月13日', avg_val_blood: '135/80', avg_val_time: 65 };}, onLoad: function onLoad() {_self = this;this.cWidth = uni.upx2px(750);this.cHeight = uni.upx2px(500); // 加载页面渲染血压的图表信息
    this.getServerData(1);}, methods: { switchTab: function switchTab(index) {this.currentIndex = index;this.getServerData(this.currentIndex + 1);}, getServerData: function getServerData(canvasId) {uni.request({ url: 'https://www.ucharts.cn/data.json', data: {}, success: function success(res) {// console.log(res.data.data)
          ...
          LineA.series = [{ data: [0, 100, 70, 20, 100, 50], name: 'aa' }];_self.showLineA(canvasId, LineA);}, fail: function fail() {_self.tips = "网络错误，小程序端请检查合法域名";} });}, showLineA: function showLineA(canvasId, chartData) {canvaLineA = new _uCharts.default({ $this: _self, canvasId: canvasId, type: 'line', fontSize: 11, colors: ['#24C789'], legend: { show: true }, dataLabel: false, dataPointShape: true, background: '#FFFFFF', pixelRatio: _self.pixelRatio, categories: chartData.categories, series: chartData.series, animation: true, xAxis: { disableGrid: true }, yAxis: { data: [{ axisLine: false }], gridType: 'dash', gridColor: '#CCC', dashLength: 2, min: 0.00, max: 150.00, format: function format(val) {return val.toFixed(0.00);} }, width: _self.cWidth * _self.pixelRatio, height: _self.cHeight * _self.pixelRatio, extra: { line: { type: 'curve' } } });}, touchLineA: function touchLineA(e) {canvaLineA.showToolTip(e, { format: function format(item, category) {return category + ' ' + item.name + ':' + item.data;} });} } };exports.default = _default;
