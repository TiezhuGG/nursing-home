...
var _heartRate = _interopRequireDefault(__webpack_require__(/*! ./pages/heart-rate/heart-rate.vue */ 73));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/* harmony import */ var _heart_rate_vue_vue_type_template_id_4633aed4___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./heart-rate.vue?vue&type=template&id=4633aed4& */ 74);
/* harmony import */ var _heart_rate_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./heart-rate.vue?vue&type=script&lang=js& */ 76);
...
/* harmony import */ var _heart_rate_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./heart-rate.vue?vue&type=style&index=0&lang=scss& */ 78);
...
var render = function() {
  ...
  var m1 = __webpack_require__(/*! ../../static/images/back2.png */ 58)
...
var _self;
var canvaLineA = null;
var mqtt = __webpack_require__(/*! ../../common/js/mqtt.min.js */ 61);var _default =
{
  data: function data() {
    return {
  ...
  methods: {
    ...
    getSocket: function () {var _getSocket = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee3() {var _this4 = this;var client;return _regenerator.default.wrap(function _callee3$(_context3) {while (1) {switch (_context3.prev = _context3.next) {case 0:_context3.next = 2;return (
                ...
                });case 6:case "end":return _context3.stop();}}}, _callee3, this);}));function getSocket() {return _getSocket.apply(this, arguments);}return getSocket;}(),
    ...
    getServerData: function () {var _getServerData = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee4() {return _regenerator.default.wrap(function _callee4$(_context4) {while (1) {switch (_context4.prev = _context4.next) {case 0:_context4.next = 2;return (
                  uni.request({
                    ...
                    } }));case 2:case "end":return _context4.stop();}}}, _callee4, this);}));function getServerData() {return _getServerData.apply(this, arguments);}return getServerData;}() } };exports.default = _default;
